...
> [!NOTE]
> **Caso — continuación del incidente de Bob**
...
> [!TIP]
> **Cómo se obtuvo la clave (contexto técnico)**
...
> [!NOTE]
> **Capacidades disponibles con RDP en claro**
...
<details>
<summary>¿Qué host inició la sesión RDP con el servidor?</summary>
...
<details>
<summary>¿Qué cuenta de usuario se usó para iniciar la conexión RDP?</summary>
...
> [!TIP]
> **Aplicable a cualquier protocolo cifrado**
