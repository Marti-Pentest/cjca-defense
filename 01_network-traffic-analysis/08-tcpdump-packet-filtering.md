...
> [!note] Sintaxis avanzada — inspección de bytes específicos
...
> [!faq]- ¿Qué filtro permite ver tráfico desde o hacia el host 10.10.20.1?
> ```bash
> host 10.10.20.1
> ```

> [!faq]- ¿Qué filtro permite capturar basado en cualquiera de dos opciones?
> `or` (o `||`)

> [!faq]- ¿Verdadero o Falso: tcpdump resuelve IPs a hostnames por defecto?
