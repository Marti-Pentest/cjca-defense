...
```
> [!tip] Cómo identificar servidor vs cliente
...
> [!note] Por qué aparecen conexiones con RESET
...
> [!note] Plantilla de análisis (aplica a cualquier pcap futuro)
